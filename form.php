...
$sql = "INSERT INTO results (`age`, `gender`, `plays_games`, `how_often`, `game_types`, `the_line`) 
VALUES ('$age', '$gender', '$plays_games', '$how_often', '$what_kind', '$online_games')";
